...
<div class="contact-section">
    <div class="contact-main-container">
        <div class="contact-container">
            <div class="card">
                <h1 class="card_title">Get in Touch</h1>
                <form class="card_form">
                    <div class="form-group">
                        <span>Subject</span>
                        <input class="form-field" type="text" placeholder="Ethical Hacking" name="subject">
                    </div>

                    <div class="form-group">
                        <input class="form-field" type="text" placeholder="Vashme Don" name="name">
                        <span>Full Name</span>
                    </div>

                    <div class="form-group">
                        <span>Phone</span>
                        <input class="form-field" type="tel" placeholder="9823948594" name="phone">
                    </div>

                    <div class="form-group">
                        <input class="form-field" type="email" placeholder="vashme@gmail.com" name="email">
                        <span>Email</span>
                    </div>

                    <div class="form-group">
                        <span>Message</span>
                        <textarea class="form-field" type="tel" placeholder="Enter your text here..." rows="5"
                                  name="subject"></textarea>
                    </div>

                    <div class="button-group">
                        <a href="#" class="boton">
                            Send<i class="fa-brands fa-telegram telegram-icon"></i>
                        </a>
                    </div>
                </form>
                <div class="card_info">
                    <p>Let us know your wish!</p>
                </div>
            </div>
        ...
        <div class="map-section">
            <div class="map-text-section">
                <h2>remember</h2>
                <h1>Contact Form</h1>
                <p>Have a project in mind? Or want to brainstorm on an idea? Want to have consultation about the
                    project? Contact us and we can have a conversation about it. We are ready to help you.</p>
            </div>
            <img src='{{asset('location.png')}}' alt="location" height="450" width="450">
        </div>
    </div>
</div>
